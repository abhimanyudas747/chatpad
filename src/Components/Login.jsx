...
const Login = (props) => {
  ...
  const [avatar, setAvatar] = useState(
    "https://firebasestorage.googleapis.com/v0/b/chatpad-18c6a.appspot.com/o/default%2Favatar%2Fdefault-avatar.png?alt=media&token=40a6eaee-f4b5-4547-ad1f-ee9b7e99d81d"
  );
    ...
    auth
      ...
      .then((res) => {
        if (uploadbtn.current.value == "") {
          ...
          storageRef
            .child(res.user.uid + "/avatar/" + uploadbtn.current.files[0].name)
            .put(uploadbtn.current.files[0])
            .then((snapshot) => {
        ...
        <div className="outer-div">
          ...
          >
            ...
            >
              ...
              />
              <br></br>
              <Image src={avatar} height="56px" width="56px" roundedCircle />
              <br></br>
              <p
                onClick={() => {
